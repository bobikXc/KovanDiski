...
type VisualizerComparisonProps = {
  beforeImage: string;
  afterImage: string;
  beforeAlt: string;
  afterAlt: string;
...
export function VisualizerComparison({
  beforeImage,
  afterImage,
  beforeAlt,
  afterAlt,
}: VisualizerComparisonProps) {
  ...
  return (
    <div className="visualizer-shell">
      ...
      >
        ...
        <span className="visualizer-badge visualizer-badge-after">После · PRIDE</span>
      ...
      <div className="visualizer-caption" aria-hidden="true">
        <span>Зажмите и двигайте</span>
        <span className="visualizer-caption-line" />
        <span>01 / 01</span>
      </div>
    </div>
  );
