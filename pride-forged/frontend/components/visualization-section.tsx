...
export function VisualizationSection() {
  return (
    <section className="visualization-section px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
      <div className="mx-auto max-w-7xl">
        <div className="visualization-panel relative isolate overflow-hidden rounded-[28px] border border-[var(--border)] p-5 shadow-[var(--shadow-liquid)] sm:rounded-[36px] sm:p-8 lg:rounded-[40px] lg:p-10 xl:p-12">
          <div className="visualization-glow visualization-glow-one" />
          <div className="visualization-glow visualization-glow-two" />

          <div className="relative z-10 grid items-center gap-9 lg:grid-cols-[0.78fr_1.22fr] lg:gap-10 xl:gap-16">
            <div className="max-w-[34rem] py-2 lg:py-8">
              <Reveal>
                <div className="flex items-center gap-3">
                  <span className="h-px w-8 bg-accent" />
                  <p className="text-xs font-bold uppercase tracking-[0.28em] text-accent sm:text-sm">Примерьте дизайн</p>
                </div>
                <h2 className="mt-5 text-[2.45rem] font-black leading-[0.98] tracking-[-0.055em] text-primary sm:text-5xl lg:text-[3.25rem] xl:text-[3.7rem]">
                  Как будут выглядеть диски на вашем авто
                </h2>
              </Reveal>
              <Reveal delay={0.1}>
                <p className="mt-6 max-w-lg text-base leading-7 text-graphite sm:text-lg sm:leading-8">
